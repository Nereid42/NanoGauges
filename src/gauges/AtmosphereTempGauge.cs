...
namespace Nereid
{
   namespace NanoGauges
   {
      ...
      public class AtmosphereTempGauge : VerticalGauge
      {
         ...
         public AtmosphereTempGauge()
            : base(Constants.WINDOW_ID_GAUGE_ATMTEMP, SKIN, SCALE, true, 0.00085f)
         {
         }
         ...
         protected override float GetScaleOffset()
         {
            ...
            if (vessel != null && IsOn())
            {
               double temp = vessel.atmosphericTemperature + Constants.MIN_TEMP;
